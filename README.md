...
curl -LO https://github.com/tailwindlabs/tailwindcss-intellisense/releases/download/v0.9.5/vscode-tailwindcss-0.9.5.vsix
unzip vscode-tailwindcss-0.9.5.vsix
```
...
```jsonc
{
  "tailwindCSS.custom.serverPath": "/path/to/.vscode/extensions/bradlc.vscode-tailwindcss-0.9.5/dist/tailwindServer.js
}
```
