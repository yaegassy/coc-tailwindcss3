...
curl -LO https://github.com/tailwindlabs/tailwindcss-intellisense/releases/download/v0.9.2/vscode-tailwindcss-0.9.2.vsix
unzip vscode-tailwindcss-0.9.2.vsix
```
...
```jsonc
{
  "tailwindCSS.custom.serverPath": "/path/to/.vscode/extensions/bradlc.vscode-tailwindcss-0.9.2/dist/tailwindServer.js
}
```
