...
curl -LO https://github.com/tailwindlabs/tailwindcss-intellisense/releases/download/v0.9.13/vscode-tailwindcss-0.9.13.vsix
unzip vscode-tailwindcss-0.9.13.vsix
```
...
```jsonc
{
  "tailwindCSS.custom.serverPath": "/path/to/.vscode/extensions/bradlc.vscode-tailwindcss-0.9.13/dist/tailwindServer.js
}
```
